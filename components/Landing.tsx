    ...
    <>
      ...
      <div className="relative w-full min-h-screen overflow-hidden flex items-center justify-center text-center">
        ...
        <div className="relative z-10 p-10 max-w-6xl mx-auto flex flex-col items-center justify-center">
          ...
          <a href="/chat" className="bg-purple-700 hover:bg-purple-800 text-white font-bold py-6 px-12 rounded inline-block mt-4 text-2xl">Start Now!</a>
        </div>
      </div>
      ...
      <div className="relative w-full min-h-screen overflow-hidden flex items-center justify-center text-center">
        ...
        <div className="relative z-10 p-10 max-w-6xl mx-auto flex flex-col items-center justify-center">
          ...
          <a href="/chat" className="bg-purple-700 hover:bg-purple-800 text-white font-bold py-6 px-12 rounded inline-block mt-4 text-2xl">Join the Revolution</a>
        </div>
      </div>
